...
export const listQuotesRules = () => [
  query('status').optional().isIn(['pending', 'preparing', 'checking', 'completed', 'cancelled', 'assigned', 'all'])
    .withMessage('Invalid status provided.'),
];

export const updateStatusRules = () => [
  validateQuoteId('quoteId'),
  body('newStatus').isIn(['pending', 'preparing', 'checking', 'completed', 'cancelled', 'assigned'])
    .withMessage('Invalid status provided.'),
];
