 ...
 */
export async function uploadKyteCSV(req: Request, res: Response) {
  try {
 ...
 * @param {Object} res - Express response object
 */
export async function getCustomersForMapping(req: Request, res: Response) {
  try {
    const companyId = req.session.companyId;
 ...
 * @param {Object} res - Express response object
 */
export async function createQuickBooksEstimates(req: Request, res: Response) {
  try {
 ...
 * @param {Object} res - Express response object
 */
export async function getConversionHistoryController(req: Request, res: Response) {
  try {
    const companyId = req.session.companyId;
